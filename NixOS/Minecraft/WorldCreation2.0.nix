...
let
  modpack = pkgs.fetchPackwizModpack {
    url = "https://raw.githubusercontent.com/VGHS-lucaruby/Minecraft-WorldCreation/2.0.0-RC12/pack.toml";
    packHash = "sha256-wAPWPOny68u8/beuuzDQg+VyKMA1mqz/R2AYGaDVaN4=";
  };
